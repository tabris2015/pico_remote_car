...
constexpr float COUNTS_PER_REV = MOTOR_CPR * GEAR_RATIO * 4;      // counting microsteps

// The pins of the motor being profiled
const pin_pair MOTOR_PINS(L_MOTOR_A_PIN, L_MOTOR_B_PIN);

// The pins of the encoder attached to the profiled motor
const pin_pair ENCODER_PINS(L_ENCODER_A_PIN, L_ENCODER_B_PIN);
